...
/**
 * @struct typedef struct ex_t
 * @brief Краткое описание какой-то структуры.
 * 
 * Подробное описание какой-то структуры.
 */
...
typedef struct ex_t {
    int field_1;     //!< Описание поля 1
    int field_2;     //!< Описание поля 2
} ex;
